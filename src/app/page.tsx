    ...
    return (
        <div className="flex flex-col min-h-screen">
                        ...
                        <div
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                    Explore some of the websites we've created
                            ...
                            {projects.map((project) => (
                                ...
                                >
                                    <Link href={project.url} passHref
                                        ...
                                        >
                                            <span
                                                className="sr-only">View {project.name}</span>
                                        </a>
                                    </Link>
                                    <div
                                        ...
                                        <Image
                                            ...
                                            className={`transition-transform group-hover:scale-105 
                                                        ${project.imageClass || 'object-cover object-center'}
                                                        `}/>
                                    </div>
                                    <div className="p-4">
                ...
                <section id="services"
                    ...
                    <div className="container px-4 md:px-6">
                        ...
                        <div
                            ...
                            <div
                                className="grid gap-1 rounded-lg border bg-card p-6">
                                <div
                                    className="flex h-12 w-12 items-center justify-center rounded-lg bg-primary text-primary-foreground">
                                    <Globe className="h-6 w-6"/>
                                </div>
                                <h3 className="text-lg font-bold">Website
                                    Development</h3>
                                <p className="text-sm text-muted-foreground">
                                    Custom-designed websites optimized for
                            ...
                            <div
                                ...
                                <h3 className="text-lg font-bold">Web
                                    Application Development</h3>
                                <p className="text-sm text-muted-foreground">
                                    Complex web applications with custom
                                    functionality to solve specific business
                                    challenges.
                                </p>
                            </div>
                            <div
                                ...
                                <h3 className="text-lg font-bold">Responsive
                                    Design</h3>
                                <p className="text-sm text-muted-foreground">
                                    Mobile-friendly websites that look great and
                        ...
                        <div
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-muted-foreground md:text-xl">
                                    ...
                                    requirements and get a free quote. We'll
                                    help turn your vision into
                                    reality.
                                </p>
                            </div>
                            ...
                            <div
                                ...
                                <div className="space-y-2">
                                    <h3 className="text-xl font-bold">Contact
                                        Form</h3>
                                    <p className="text-sm text-muted-foreground">
                                        Fill out the form below, or email:
                                        contact@aladi.ca and we'll get back to
                                        you soon.
                                    </p>
                                </div>
                ...
                <section id="about"
                    ...
                    <div className="container px-4 md:px-6">
                        <div
                            ...
                            <div className="space-y-4">
                                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">About
                                    Us</h2>
                                <p className="text-muted-foreground md:text-xl/relaxed">
                                    At Aladi, we believe in creating stunning
                                    digital experiences. Our team combines
                                    technical
                                    expertise with creative design to help
                                    businesses grow and thrive in the digital
                                    world.
                                </p>
                            </div>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-xl font-semibold">Get in
                                    Touch</h3>
                                <div
                                    ...
                                    <p className="flex items-center gap-2">
                                        ...
                                        <span>•</span>
                                        <a href="mailto:contact@aladi.ca"
            ...
            <footer className="border-t">
                <div
                    className="container flex flex-col gap-4 py-10 md:flex-row md:gap-8 md:py-12 px-4 md:px-6">
